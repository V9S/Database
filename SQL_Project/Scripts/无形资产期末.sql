...
SELECT * FROM zcwxzc a WHERE a.cardobjectid NOT IN (SELECT b.cardobjectid FROM czwxzc b);--删除


SELECT * FROM czwxzc b WHERE b.cardrecid NOT IN (SELECT a.cardid FROM zcwxzc a);--插入
