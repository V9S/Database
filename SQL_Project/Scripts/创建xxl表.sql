...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (2, 2, '0/5 * * * * ?', '事项同步导入数据处理', 'TableThreadService', '2020-06-22 02:13:28', '2020-06-22 02:28:26', '焦伟恒', '', 'FIRST', 'TableThreadService', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 02:13:28', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (3, 2, '1 0 0 * * ?', '终端打印机纸张数监控', 'ListenPaperPlanTaskExecutor', '2020-06-22 02:14:46', '2020-06-23 10:02:30', '李瑞奇', '', 'FIRST', 'ListenPaperPlanTaskExecutor', '', 'SERIAL_EXECUTION', 20, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 02:14:46', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (4, 2, '1 0 0 * * ?', '终端打印监控网络', 'ListenNetworkPlanTask', '2020-06-22 02:15:51', '2020-06-23 10:02:13', '李瑞奇', '', 'FIRST', 'ListenNetworkPlanTask', '', 'SERIAL_EXECUTION', 3, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 02:15:51', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (5, 2, '0 0 1 * * ?', '财务核算（天翼）', 'CWJKPlanTaskExecutor', '2020-06-22 02:16:40', '2020-06-22 03:04:28', '冯佳帅', '', 'FIRST', 'CWJKPlanTaskExecutor', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 02:16:40', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (6, 2, '0 0 1 * * ?', '校内处置公示自动审批', 'DisposalFormulaPlanTaskExecutor', '2020-06-22 02:17:21', '2020-06-29 05:01:39', '邸鹏', '', 'FIRST', 'DisposalFormulaPlanTaskExecutor', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 02:17:21', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (7, 2, '0 0 0 1 1/3 ?', '日志归档', 'GamsLogBackupService', '2020-06-22 03:02:51', '2020-06-22 03:02:51', '王振龙', '', 'FIRST', 'GamsLogBackupService', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 03:02:51', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (8, 2, '0 0 1 * * ?', '财务核算（天财）', 'TCJKPlanTaskExecutor', '2020-06-22 03:05:13', '2020-06-22 03:05:13', '冯佳帅', '', 'FIRST', 'TCJKPlanTaskExecutor', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2020-06-22 03:05:13', '', 0, 0, 0);
...
CREATE TABLE `xxl_job_log`  (
  ...
  `billid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '业务id',
