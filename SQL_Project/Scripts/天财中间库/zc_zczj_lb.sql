/*
 ...
 Date: 03/01/2020 10:23:57
*/


-- ----------------------------
-- Table structure for zc_zczj_lb
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[zc_zczj_lb]') AND type IN ('U'))
	DROP TABLE [dbo].[zc_zczj_lb]
GO

CREATE TABLE [dbo].[zc_zczj_lb] (
...
ALTER TABLE [dbo].[zc_zczj_lb] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Primary Key structure for table zc_zczj_lb
-- ----------------------------
ALTER TABLE [dbo].[zc_zczj_lb] ADD CONSTRAINT [PK_zc_zczj_lb] PRIMARY KEY CLUSTERED ([ywdh], [bh])
