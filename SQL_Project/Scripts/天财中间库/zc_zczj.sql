/*
 ...
 Date: 03/01/2020 10:23:48
*/


-- ----------------------------
-- Table structure for zc_zczj
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[zc_zczj]') AND type IN ('U'))
	DROP TABLE [dbo].[zc_zczj]
GO

CREATE TABLE [dbo].[zc_zczj] (
...
ALTER TABLE [dbo].[zc_zczj] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Primary Key structure for table zc_zczj
-- ----------------------------
ALTER TABLE [dbo].[zc_zczj] ADD CONSTRAINT [PK_zc_zczj] PRIMARY KEY CLUSTERED ([ywdh], [bh])
