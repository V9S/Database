/*
 ...
 Date: 03/01/2020 10:23:15
*/


-- ----------------------------
-- Table structure for zc_xmeddjmx
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[zc_xmeddjmx]') AND type IN ('U'))
	DROP TABLE [dbo].[zc_xmeddjmx]
GO

CREATE TABLE [dbo].[zc_xmeddjmx] (
  ...
  [edkzbm] varchar(20) COLLATE Chinese_PRC_CI_AS  NULL,
...
ALTER TABLE [dbo].[zc_xmeddjmx] SET (LOCK_ESCALATION = TABLE)
GO


-- ----------------------------
-- Primary Key structure for table zc_xmeddjmx
-- ----------------------------
ALTER TABLE [dbo].[zc_xmeddjmx] ADD CONSTRAINT [PK_zc_xmeddjmx] PRIMARY KEY CLUSTERED ([pllsh], [ywdh])
