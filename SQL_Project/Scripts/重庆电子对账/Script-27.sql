...
--	AND bb.jizqj = aa.jizqj
 ...
 SELECT sum(aa.zhejje) AS zhejje FROM GAMS_ASSETDEPRECDETAIL  aa WHERE aa.JIZQJ = '202011';
...
SELECT * FROM GAMS_CARD gc WHERE gc.BILLCODE = 'JJ2020000288';
...
UPDATE GAMS_ASSETDEPRECDETAIL SET JIZQJ = '202011' WHERE COMMENTS  = '拆分新增' OR COMMENTS = '拆分减少';
