...
SELECT * FROM GAMS_CARD_CHANGE gcc WHERE gcc.BIZTYPE IS NOT  NULL ;

UPDATE GAMS_CARD_CHANGE SET BIZTYPE = 'com.jiuqi.np.gams2.business.bill.InspectionEntryBillDefine' WHERE BIZTYPE IS NULL  ;