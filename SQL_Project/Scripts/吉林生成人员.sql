...
delete from NP_USER where name in ('sadmin','audmin','qadmin') and id not in (select id from np_user_bak1217);
...
UPDATE GAMS_JC_PERSONNEL SET USERID = (SELECT USERID FROM GAMS_JC_PERSONNEL_BAK1217 gjp WHERE id = 'ABCEA49DBB6D451BA9BD9CAC9A48E498') WHERE id = '757804E20000036159930B1099D71E26';

SELECT * FROM GAMS_JC_PERSONNEL gjp WHERE name = '李孟瑜';
SELECT * FROM GAMS_JC_PERSONNEL_BAK1217 gjp WHERE name = '李孟瑜';
-----李孟瑜
...
imp jltdxnp/jltdxnp@orcl file=D:\database\JLTL\1.dmp full=y ignore=y;